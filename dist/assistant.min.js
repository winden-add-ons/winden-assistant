...
`;var E="tw-element-active";var L=()=>{[...document.querySelectorAll(`.${E}`)].forEach(n=>n.classList.remove(E))},p=n=>{L(),n.classList.add(E)};function B(){y();let n=setInterval(()=>{if(tailwindScreens?.length){let b=function(e){e.preventDefault(),t.className=u.value,d=h(t)};clearInterval(n);let r=document.createElement("div");r.innerHTML=`
