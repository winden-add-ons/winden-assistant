...
`;function k(){E();let n=setInterval(()=>{if(tailwindScreens?.length){let x=function(e){e.preventDefault(),t.className=d.value,r=g(t)};clearInterval(n);let s=document.createElement("div");s.innerHTML=`
