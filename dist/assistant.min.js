...
`;function C(){k();let o=setInterval(()=>{if(tailwindScreens?.length){let x=function(e){e.preventDefault(),t.className=p.value,p.blur(),d=w(t)};clearInterval(o);let a=document.createElement("div");a.innerHTML=`
