...
export default function () {
    ...
    const tailwindScreensTimer = setInterval(() => {
      ...
      <details id="twaPopup" class="relative bg-indigo-800 open:bg-white text-slate-900 border border-solid border-slate-600 open:border-slate-300 shadow-md rounded-lg group overflow-hidden max-w-sm open:w-screen">
